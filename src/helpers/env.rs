...
impl EnvVars {
    pub fn get(&self) -> String {
        match self {
            ...
            Self::JWT_LOGIN_SECRET => {
                env::var("JWT_LOGIN_SECRET").expect("JWT_LOGIN_SECRET must be set")
            }
    ...
    pub fn validate() {
        ...
        else if Self::JWT_LOGIN_SECRET.get().is_empty() {
            panic!("JWT_LOGIN_SECRET must not be empty");
        }
